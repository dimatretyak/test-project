...
export const CompareWithItem = (props) => {
    ...
    const productMeasures = measures(props.product, compareWithItemCalculations.product.size, props.unit);
    const itemMeasures = measures(props.item, compareWithItemCalculations.item.size, props.unit);
